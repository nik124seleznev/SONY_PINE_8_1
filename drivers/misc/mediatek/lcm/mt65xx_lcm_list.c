...
//[nik-kst][SM31][Raymond Lin] LCM porting  begin
#if defined(R6135_HD720_DSI_VDO)
	&r6135_hd720_dsi_vdo_lcm_drv,
#endif
//[nik-kst][SM31][Raymond Lin] LCM porting  end

//[nik-kst][SM31][Raymond Lin] Truly OPT LCM begin
#if defined(R6135OTP_HD720_DSI_VDO)
	&r6135otp_hd720_dsi_vdo_lcm_drv,
#endif
//[nik-kst][SM31][Raymond Lin] Truly OPT LCM end
